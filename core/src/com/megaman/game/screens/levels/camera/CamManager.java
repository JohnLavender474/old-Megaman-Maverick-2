...
public class CamManager implements Updatable, Resettable {
    ...
    private CamFocusable focusable;
    ...
    public void set(Array<RectangleMapObject> gameRooms, CamFocusable focusable) {
    ...
    public void setFocusable(CamFocusable focusable) {
